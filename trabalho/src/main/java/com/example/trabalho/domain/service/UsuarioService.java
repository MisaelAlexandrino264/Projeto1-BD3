...
import com.example.trabalho.domain.dto.usuario.UsuarioRequestDTO;
import com.example.trabalho.domain.dto.usuario.UsuarioResponseDTO;
import com.example.trabalho.domain.exception.BadRequestException;
import com.example.trabalho.domain.exception.ResourceNotFoundException;
import com.example.trabalho.domain.model.Usuario;
import com.example.trabalho.domain.repository.UsuarioRepository;
...
private BCryptPasswordEncoder bCryptPasswordEncoder;
    ...
    public UsuarioResponseDTO cadastrar(UsuarioRequestDTO dto) {
      if(dto.getEmail() == null || dto.getSenha() == null){
        throw new 
        BadRequestException("Email e Senha são Obrigatórios!");
      }
      Optional<Usuario> optUsuario = 
      usuarioRepository.findByEmail(dto.getEmail());
      if(optUsuario.isPresent()){
        throw new 
        BadRequestException("Já existe um usuário cadastrado com esse email!");     
     }
